var rsiscool = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    function findWasmBinary() {
      if (Module["locateFile"]) {
        var f = "rsiscool_workers.wasm";
        if (!isDataURI(f)) {
          return locateFile(f);
        }
        return f;
      }
      return new URL("rsiscool_workers.wasm", import.meta.url).href;
    }
    var wasmBinaryFile;
    ...
    var __emscripten_timeout = (a0, a1) =>
      (__emscripten_timeout = wasmExports["I"])(a0, a1);
